    ...
    if(angka == 1){
            ...
            bangunDatar = fa.nextInt();
                 ...
                 switch(bangunDatar){
                        ...
                        //LINGKARAN
                        case 4:
                        System.out.println("Input Pii : 3.14");
                        double pii = Math.PI;
                        System.out.println("Input Jari-jari:  ");
                        int jari2 = fa.nextInt();
                        ...
                        case 5:
                        System.out.println("Input Alas: ");
                        int alas2 = fa.nextInt();
                        System.out.println("Input Tinggi: ");
                        int tinggi2 = fa.nextInt();
                        ...
                        int panjangSisi = fa.nextInt();
                        System.out.println("Input Tinggi: ");
                        int tinggi3 = fa.nextInt();
                        ...
                        case 7:
                        System.out.println("Input Alas: ");
                        int alas4 = fa.nextInt();
                        System.out.println("Input Tinggi: ");
                        int tinggi4 = fa.nextInt();
                        ...
                        int diagonal1 = fa.nextInt();
                        System.out.println("Input Diagonal2: ");
                        int diagonal2 = fa.nextInt();
